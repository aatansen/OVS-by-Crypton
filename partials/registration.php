    ...
    <div class="bg-info py-4">
        ...
        <div class="container text-center">
            <form action="form.php">
                ...
                <div class="mb-3">
                    <input type="text" class="form control w-50 m-auto" placeholder="Enter your password"
                        required="required" name="password">

                </div>
                <div class="mb-3">
                    <input type="text" class="form control w-50 m-auto" placeholder="Confirm password"
                ...
                <p>Already have an Account?
                    <a href="../" class="text-white"></a>Logine Here
                </p>
            </form>
        </div>
    </div>
